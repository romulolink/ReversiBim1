...
public class ReversiBoard {
    ...
    public void set(Move move, TKind player) {
        ...
        // Atribui o movimento atual ao jogador
        board[move.i][move.j]=player;

        // Incrementa o contador do jogador
        switch (player) {
            case white:  counter[1]++; break;
            case black:  counter[0]++; break;
        }
    ...
    // Retorna a contagem do jogador desejado
    ...
    // Finaliza o jogo caso já se tenha efetuado 64 movimentos
